...
export const Route = createFileRoute('/$lang/_libraries/start/$version/')({
...
const librariesRouteApi = getRouteApi('/$lang/_libraries')

const library = getLibrary('start')

export default function VersionIndex() {
  const { sponsorsPromise } = librariesRouteApi.useLoaderData()
  const { lang } = librariesRouteApi.useParams()
    ...
    <div className="flex flex-col gap-20 md:gap-32 max-w-full pt-32">
      <div className="flex flex-col items-center gap-8 text-center px-4">
        ...
        <div className="flex justify-center gap-4 flex-wrap">
          <Link
            to="/$lang/$libraryId/$version/docs/framework/$framework/$"
            params={{
              lang,
              libraryId: 'start',
              version: 'latest',
      ...
      <div className="space-y-8 px-4">
        ...
        <div className="grid items-center gap-2 justify-center grid-cols-2 w-[600px] max-w-full mx-auto">
          <Link
            to="/$lang/$libraryId/$version/docs/framework/$framework/examples/$"
            params={{
              lang,
              libraryId: 'start',
              version: 'latest',
              framework: 'react',
              _splat: 'examples/start-basic',
            }}
