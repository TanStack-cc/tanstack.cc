...
export const Route = createFileRoute('/$lang/_libraries/form/$version/')({
...
export default function FormVersionIndex() {
  ...
  const { lang, version } = Route.useParams()
    ...
    <>
      <div className="flex flex-col gap-20 md:gap-32 max-w-full pt-32">
        <div className="flex flex-col items-center gap-8 text-center px-4">
          ...
          <Link
            to="/$lang/$libraryId/$version/docs"
            params={{
              lang,
              libraryId: 'form',
              version: 'latest',
        ...
        {/* <div className="px-4 w-[500px] max-w-full mx-auto">
          ...
          >
            ...
            <div className="flex flex-col p-4 gap-4">
              ...
              <a
                href="mailto:partners@tanstack.dev?subject=TanStack Form Partnership"
